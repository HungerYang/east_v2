...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    for resFile in gt:
        ...
        for n in range(len(pointsList)):
            ...
            dontCare = transcription == '#'*len(transcription) 
    ...
    methodRecall, methodPrecision, methodHmean = round(100*methodRecall,2), round(100*methodPrecision,2), round(100*methodHmean,2)
